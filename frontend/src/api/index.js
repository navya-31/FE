...
export const getRoomRequestsByHotelId = (id) => API.get(`/roomRequests/h/${id}`)
...
export const getReviewsByUserAndHotel = (uid, hid) => API.get(`reviews/userhotel/${uid}/${hid}`)
...
export const updateHotel = (id,newHotel) => API.patch(`/hotels/${id}`,newHotel)
