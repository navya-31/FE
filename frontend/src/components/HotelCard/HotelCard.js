...
function HotelCard({ currentUser, currentHotel, currentTenant, setCurrentId }) {
    ...
    const leave = async() => {
        ...
        console.log(currentTenant.room_id, currentTenant.user_id, currentHotel._id)
        Swal.fire({
            ...
            if (result.isConfirmed) {
                await api.leaveRoom(currentTenant[0].room_id,currentTenant[0].user_id,currentHotel[0]._id)
        ...
        <Card className={classes.card}>
            ...
            <CardContent className={classes.overlay2}>
                ...
                <Typography gutterBottom variant='h4' >
                    You are living in {currentTenant[0].hotel_name}
                </Typography>
                <Typography variant='body2'  >
                    Every hotel has a meal system. That requires at least one grocery shopping chore per person, every month. With meal system, you get to enjoy home made quality meals everyday for lunch and dinner. Care to join?
                </Typography>
