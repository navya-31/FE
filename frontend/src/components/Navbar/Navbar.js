...
function ResponsiveAppBar({user, setUser}) {
  ...
  return (
    ...
    <AppBar position="static" style={{backgroundColor:"#3a3b7b", zIndex:'999', top:'0', width:'100%' }}>
              ...
              {pages.map((page) => (
                <MenuItem key={page} onClick={handleCloseNavMenu}>
                  <Typography textAlign="center">
                    <Link style={{ textDecoration:'none',fontFamily:'tahoma',color:"#3a3b7b"}} to={`/${page}`}>
                    {page}
                    </Link>
                  </Typography>
                </MenuItem>
          ...
          <Box sx={{ flexGrow: 0 }}>
            ...
            (
              ...
              <IconButton onClick={handleOpenUserMenu} sx={{ p: 0 }}>
                <Avatar alt={user?.result.name} style={{backgroundColor:"#a65acc" }} src="#" />
                <MenuIcon 
