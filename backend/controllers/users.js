...
export const signin = async (req, res) => {
    ...
    try{
        ...
        const token = jwt.sign({email: existingUser.email, id: existingUser._id, role: existingUser.role}, process.env.JWT_TOKEN, {expiresIn: '1h'});
...
export const signup = async (req, res) => {
    ...
    try{
        ...
        const token = jwt.sign({email: result.email, id: result._id, role: result.role}, process.env.JWT_TOKEN, {expiresIn: '1h'});
